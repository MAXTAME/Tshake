...
send(msg.chat_id_, msg.id_, 1, '☑┇تم مسح قائمه الاداريين', 1, 'md')
end
...
if text:match("^الغاء pin$") and is_owner(msg) or text:match("^الغاء التثبيت") and is_owner(msg) then
unpinmsg(msg.chat_id_)
send(msg.chat_id_, msg.id_, 1, '☑┇تم الغاء تثبيت الرساله', 1, 'md')
end
...
⚜️┇ 《 قائمه المنع 》
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
🕳┇ 《 تثبيتث-pin-ثبت/الغاء التثبيت-pin 》
🕳┇ 《 الاعدادات 》
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
⚜️┇ 《 الرابط 》
⚜️┇ 《 القوانين 》
...
🕳┇《 مسجاتي 》
🕳┇《 ابلاغ 》
🕳┇《 معلومات 》لعرض معلومات عن المجموعه
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
⚜️┇《 وضع اسم 》
⚜️┇《 وضع رابط 》
⚜️┇《 وضع صوره 》
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
❌┇<a href="https://telegram.org/deactivate">اضغط هنا لمسح الحساب" </a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
end
...
if not is_vip(msgg) then
check_filter_words(result, text)
if text:match("[ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz]") then
if database:get("lock_en:MAX"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs) end end end 
if not is_vip(msgg) then
